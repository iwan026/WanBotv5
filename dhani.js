...
*EMERALD STORE MELAYANI*
_*• TOP UP GAME*_
_*• ISI ULANG PULSA*_
_*• TOP UP SALDO EWALLET*_
_*• TOKEN LISTRIK*_
_*• JASA POST FREE*_
_*• JASA REKBER*_

_*Silahkan Pilih Listnya Dibawah*_
_________________________________`
teks =
`「 ${botname} 」\n*${tanggal}*`
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}store`, buttonText: { displayText: 'sᴛᴏʀᴇ' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
break
